...
/**
 * O(n) time using an Efficient Solution. The idea is to use Hashing. We first
 * insert all elements in a Hash. 
 * Then check all the possible starts of
 * consecutive subsequences.
 * 
 * @author VijaySidhu
 *
 */
public class LongestConsectiveLengthFinder {
